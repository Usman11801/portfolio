...
export const projects = [
  {
    name: "Reflect",
    category: "AI & ML",
    field: "AI Note-Taking",
    accent: "#7c5cff",
    summary:
      "A networked, AI-powered note-taking and journaling app that acts as a personal 'second brain' — capturing, connecting and resurfacing ideas with backlinks and GPT-4.",
    features: [
      "Networked notes with backlinks",
      "AI transcription & outlining (GPT-4 + Whisper)",
      "Browser clipper & voice capture",
      "End-to-end encrypted sync",
    ],
    stack: ["React", "GPT-4", "Whisper", "End-to-end Encryption"],
  ...
  },
  {
    ...
    accent: "#f59e0b",
    summary:
      "An AI SQL chatbot that lets non-technical users query and visualize their databases through natural-language conversation instead of writing SQL — with dashboards and embeddable widgets.",
    features: [
      "Natural-language querying, no SQL required",
      "Auto-generated charts & dashboards",
      "Multi-database (Postgres, MySQL, Snowflake, BigQuery)",
      "Fine-grained access control & on-prem option",
    ],
    stack: ["LLM Text-to-SQL", "React", "DB Connectors", "Data Viz"],
  ...
  },
  {
    name: "Retell AI",
    category: "AI & ML",
    field: "AI Voice Agents",
    accent: "#f97316",
    summary:
      "An AI voice agent platform for automating inbound and outbound phone calls with ultra-realistic, low-latency voices — receptionists, scheduling, lead qualification and support.",
    features: [
      "~600ms human-like voice conversations",
      "Drag-and-drop call-flow builder",
      "Real-time function calling (booking, payments)",
      "Omni-channel with HIPAA / SOC2 / GDPR",
    ],
    stack: ["LLM Voice Agents", "Real-time Streaming", "Telephony APIs", "REST API / SDK"],
    link: "https://www.retellai.com",
  },
  {
    name: "Gavel",
    category: "Legal",
    field: "AI Contract & Document Automation",
    accent: "#2563eb",
    summary:
      "An AI-powered legal contract review and document automation platform — turning client intake answers into finished documents and generating first-pass contract reviews against firm standards.",
    features: [
      "AI first-pass contract review with playbooks",
      "Document automation from intake forms",
      "Redlining & clause rewriting in Word",
      "Secure encrypted client intake",
    ],
    stack: ["React", "Python", "AI / LLM", "PostgreSQL"],
    link: "https://www.gavel.io",
  },
  {
  ...
  },
  {
    name: "Capsule CRM",
    category: "CRM",
    field: "Small-Business CRM",
    accent: "#c084fc",
    summary:
      "A simple, flexible CRM for small businesses to manage contacts, sales pipelines and tasks — keeping every customer relationship and deal organized in one place.",
    features: [
      "Contact management with full history",
      "Visual sales pipeline & deals",
      "Tasks, calendar & email integration",
      "Reports & workflow automation",
    ],
    stack: ["Ruby on Rails", "JavaScript", "PostgreSQL", "REST API"],
    link: "https://capsulecrm.com",
  },
  {
    name: "Rentana",
    category: "Real Estate & FinTech",
    field: "Real Estate Revenue Intelligence",
    accent: "#facc15",
    summary:
      "An AI-powered revenue intelligence and analytics platform for real estate investors and multifamily teams — turning scattered property data into pricing recommendations and portfolio visibility.",
    features: [
      "Predictive market & portfolio analytics",
      "AI rent pricing & renewal optimization",
      "Portfolio performance dashboards",
      "Automated recurring reports",
    ],
    stack: ["React", "Next.js", "Python", "Machine Learning"],
    link: "https://www.rentana.io/",
  },
  {
    name: "IntelliShift",
    category: "Fleet & Logistics",
    field: "Fleet Telematics & Tracking",
    accent: "#0891b2",
    summary:
      "A unified fleet management and telematics platform combining GPS vehicle tracking, AI dash cams, maintenance and compliance in a single application for commercial fleets.",
    features: [
      "Real-time GPS fleet & asset tracking",
      "AI dash cams & driver safety",
      "ELD compliance & inspections",
      "Predictive maintenance & analytics",
    ],
    stack: ["React", "Node.js", "PostgreSQL", "IoT / GPS"],
    link: "https://intellishift.com/",
  },
  {
    name: "Maintenance Care",
    category: "Facility & Construction",
    field: "Facility Management (CMMS)",
    accent: "#14b8a6",
    summary:
      "A cloud-based CMMS for facility maintenance teams — covering work orders, preventive maintenance and asset tracking via web dashboard and mobile app.",
    features: [
      "Work order management & notifications",
      "Preventive maintenance scheduling",
      "Asset tracking & capital planning",
      "Parts/inventory & mobile app",
    ],
    stack: ["Cloud SaaS", "Responsive Web", "iOS / Android", "REST API"],
    link: "https://www.maintenancecare.com/",
  },
  {
    name: "BuildScan",
    category: "Facility & Construction",
    field: "Construction Defect & Snagging",
    accent: "#78716c",
    summary:
      "A multi-platform construction defect management and snagging app — managing snag lists, inspection checklists and project workflow with real-time collaboration.",
    features: [
      "Log defects with photos, due dates & status",
      "Pre-built & custom inspection checklists",
      "Team/contractor collaboration & permissions",
      "Custom shareable defect reports",
    ],
    stack: ["Mobile Apps", "Cloud Sync", "Responsive Web", "PDF Reports"],
    link: "https://buildscan.co/",
  },
  {
    name: "Optevo",
  ...
  },
  {
    name: "Missive",
    category: "SaaS & Productivity",
    field: "Team Inbox & Collaboration",
    accent: "#0d9488",
    summary:
      "A team inbox and collaboration app that lets teams manage shared email, chat and tasks together in one place — coordinating work around email without forwarding chaos.",
    features: [
      "Shared inboxes with threaded internal chat",
      "Turn emails into assignable tasks",
      "25+ integrations & AI assistant",
  ...
  },
  {
    name: "CazVid",
    category: "Mobile",
    field: "Jobs / Video Resume App",
    accent: "#e11d48",
    summary:
      "A mobile-first global hiring app where job seekers record short video resumes and employers match with candidates via AI — with iOS, Android and a full web platform.",
    features: [
      "In-app video resume recording",
      "AI candidate fit-scoring",
      "Swipe-style candidate search",
      "1-click apply & built-in messaging",
    ],
    stack: ["React Native", "Next.js", "Node.js", "AI Matching"],
    link: "https://cazvid.com/",
  },
  ...
  {
    name: "Spires Online Tutors",
    category: "Education",
    field: "Online Tutoring Marketplace",
    accent: "#7c3aed",
    summary:
      "An online tutoring marketplace connecting students with professional tutors across 400+ subjects — lessons booked, taught, recorded and paid for entirely online.",
    features: [
      "Tutor discovery & bidding",
      "In-browser recorded video classes",
      "Secure online payments",
      "GCSE to professional levels",
    ],
    stack: ["Ruby on Rails", "PostgreSQL", "React", "WebRTC"],
    link: "https://spires.co",
  },
  {
    name: "TenantCloud",
    category: "Real Estate & FinTech",
  ...
  },
  {
    name: "Nuclino",
    category: "SaaS & Productivity",
    field: "Team Wiki & Knowledge Base",
    accent: "#6366f1",
    summary:
      "A lightweight team wiki and knowledge-base tool for organizing documents, notes and projects in one collaborative workspace — a fast, simple alternative to bloated suites.",
    features: [
      "Unified docs, knowledge & projects",
      "Real-time collaborative editing",
      "Instant search & keyboard nav",
      "List, board & graph views",
    ],
